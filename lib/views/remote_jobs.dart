      ...
      child: Column(
        children: [
          ...
          const CareerCard(
            ...
            location: 'Lahore',
            description:
                'Develop and manage both front and back-end web solutions.',
            recruitmentInfo: 'This job represented by DK Recruitment',
          ),
          const SizedBox(height: 10),
          const CareerCard(
          ...
          Padding(
            ...
            child: CustomText(
              content:
                  'At Social Swirl, our internship program has been providing valuable industry experience since 2021. Our certification is recognized for its comprehensive training and\n practical exposure to real-world projects. Interns gain hands-on experience with cutting-edge\n technologies, making our certificate a testament to their skills and dedication.\n This valuable credential significantly enhances career prospects and professional growth.',
              fontsize: 17,
            ),
          ),
          Padding(
          ...
          const SizedBox(height: 10,),
          CustomText(content: "Explore Social Swirl's internship program for a chance to gain hands-on experience, develop your skills in a dynamic environment, and work on real-world projects. Enhance your career prospects with our comprehensive and supportive training.",fontsize: 17,),
          const SizedBox(height: 10,),
          CustomButton(content: 'Get Started', onTap: (){}),
          SizedBox(height: 250,child: Image.asset('lib/assets/Remote.png',fit: BoxFit.cover,),)
        ],
      ),
    );
  }
